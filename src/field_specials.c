...
u8 CountRotomInParty (void)
{
    ...
    for (i = 0; i < partyCount; i++)
    {
       ...
       if (species == SPECIES_ROTOM || species == SPECIES_ROTOM_HEAT || species == SPECIES_ROTOM_WASH || species == SPECIES_ROTOM_FROST || species == SPECIES_ROTOM_FAN || species == SPECIES_ROTOM_MOW)
        {
