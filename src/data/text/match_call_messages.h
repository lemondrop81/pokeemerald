...
const u8 gText_MatchCallRockinWhiz_Sandy_Strategy[] = _("ROCK-type power attack.");
const u8 gText_MatchCallRockinWhiz_Sandy_Pokemon[] = _("I prefer rock-hard POKéMON.");
const u8 gText_MatchCallRockinWhiz_Sandy_Intro1[] = _("A LEADER of a big GYM bears");
const u8 gText_MatchCallRockinWhiz_Sandy_Intro2[] = _("a lot of responsibility.");
...
const u8 *const gMatchCallFlavorTexts[REMATCH_TABLE_ENTRIES][CHECK_PAGE_ENTRY_COUNT] =
{
    ...
    [REMATCH_Sandy] = MCFLAVOR(RockinWhiz_Sandy),
