...
static const struct TrainerMonItemCustomMoves sParty_Parker[] = {
    ...
    .iv = 255,
    .lvl = 1,
    .ability = 2, // Sap seeker
    .species = SPECIES_GIRAFARIG,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CONFUSE_RAY, MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_George[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_IRON_DEFENSE, MOVE_SOFT_BOILED, MOVE_TOXIC_SPIKES, MOVE_SUBSTITUTE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Jody[] = {
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_SLASH, MOVE_X_SCISSOR, MOVE_CLOSE_COMBAT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .moves = {MOVE_LEAF_STORM, MOVE_VOLT_SWITCH, MOVE_TRICK, MOVE_ELECTROWEB}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_LEAF_STORM, MOVE_DRAGON_PULSE, MOVE_FIRE_BLAST, MOVE_SUBSTITUTE}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_SWORDS_DANCE, MOVE_SPORE, MOVE_MACH_PUNCH, MOVE_BULLET_SEED}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_SLUDGE_BOMB, MOVE_FLAMETHROWER, MOVE_SYNTHESIS}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .moves = {MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_MOONBLAST, MOVE_WILL_O_WISP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_STEALTH_ROCK, MOVE_EARTHQUAKE, MOVE_DRAGON_TAIL, MOVE_FIRE_BLAST}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .moves = {MOVE_SLUDGE_WAVE, MOVE_DRACO_METEOR, MOVE_TOXIC_SPIKES, MOVE_FIRE_BLAST}
    },
    {
    .iv = 250,
    .lvl = 52,
    ...
    .iv = 255,
    .lvl = 53,
    .ability = 1, // Sound Proof
    .species = SPECIES_KOMMO_O,
    .heldItem = ITEM_KOMMONIUM_Z,
    .moves = {MOVE_CLANGING_SCALES, MOVE_CLOSE_COMBAT, MOVE_POISON_JAB, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 255,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_CHOICE_SCARF,
    .moves = {MOVE_HYDRO_PUMP, MOVE_HURRICANE, MOVE_U_TURN, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_DARK_PULSE, MOVE_GUNK_SHOT, MOVE_ICE_BEAM, MOVE_PSYCHIC}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .moves = {MOVE_SURF, MOVE_PSYCHIC, MOVE_RAIN_DANCE, MOVE_TAIL_GLOW}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .moves = {MOVE_WATERFALL, MOVE_EARTHQUAKE, MOVE_SLUDGE_WAVE, MOVE_ROCK_SLIDE}
    }
};

static const struct TrainerMonItemCustomMoves sParty_Sandy1[] = {
    {
    .iv = 100,
    .lvl = 1,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .moves = {MOVE_CALM_MIND, MOVE_PSYSHOCK, MOVE_REST, MOVE_TOXIC}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_NINETALES_ALOLAN,
    .heldItem = ITEM_LIGHT_CLAY,
    .moves = {MOVE_FREEZE_DRY, MOVE_MOONBLAST, MOVE_ENCORE, MOVE_AURORA_VEIL}
    },
    {
    .iv = 200,
    .lvl = 1,
    ...
    .species = SPECIES_MAMOSWINE,
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_EARTHQUAKE, MOVE_ENDEAVOR, MOVE_ICE_SHARD, MOVE_STEALTH_ROCK}
    },
    {
    .iv = 200,
    .lvl = 1,
...
static const struct TrainerMonNoItemCustomMoves sParty_Josh[] = {
    ...
    .moves = {MOVE_BULLDOZE, MOVE_SLASH, MOVE_SUCKER_PUNCH, MOVE_ASTONISH}
    },
    {
    .iv = 100,
    .lvl = 1,
    .species = SPECIES_YAMASK_GALARIAN,
    .moves = {MOVE_SHADOW_BALL, MOVE_BRUTAL_SWING, MOVE_DISABLE, MOVE_EARTH_POWER}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Jared[] = { // With Ashley
    {
    .iv = 100,
    .lvl = 1,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Edwardo[] = { // With Flint
    {
    .iv = 150,
    .lvl = 1,
...
static const struct TrainerMonNoItemCustomMoves sParty_Jocelyn[] = {
    {
    .iv = 127,
    .lvl = 1,
    .species = SPECIES_POOCHYENA,
    .moves = {MOVE_HOWL, MOVE_TACKLE, MOVE_BITE, MOVE_ROAR}
    },
    {
    .iv = 127,
    .lvl = 1,
    .species = SPECIES_STUNKY,
    .moves = {MOVE_ACID_SPRAY, MOVE_BITE, MOVE_FOCUS_ENERGY, MOVE_SMOKESCREEN}
    },
    {
    .iv = 127,
    .lvl = 1,
    .species = SPECIES_GRIMER_ALOLAN,
    .moves = {MOVE_SLUDGE, MOVE_MUD_SLAP, MOVE_THIEF, MOVE_CURSE}
    },
    {
    .iv = 127,
    .lvl = 1,
...
static const struct TrainerMonNoItemCustomMoves sParty_Laura[] = {
    {
    .iv = 150,
    .lvl = 1,
    .species = SPECIES_RATTATA_ALOLAN,
    .moves = {MOVE_BITE, MOVE_QUICK_ATTACK, MOVE_TAKE_DOWN, MOVE_FLAME_WHEEL}
    },
    {
    .iv = 150,
    .lvl = 1,
    .species = SPECIES_MEOWTH_ALOLAN,
    .moves = {MOVE_FAKE_OUT, MOVE_BITE, MOVE_U_TURN, MOVE_PROTECT}
    },
    {
    .iv = 150,
    .lvl = 1,
...
static const struct TrainerMonNoItemCustomMoves sParty_Brenden[] = {
    ...
    .lvl = 1,
    .species = SPECIES_HOUNDOUR,
    .moves = {MOVE_BITE, MOVE_FIRE_FANG, MOVE_THUNDER_FANG, MOVE_FACADE}
    },
    {
    .iv = 100,
    .lvl = 1,
...
static const struct TrainerMonNoItemCustomMoves sParty_Lilith[] = {
    {
    .iv = 150,
    .lvl = 1,
    .species = SPECIES_VULLABY,
...
static const struct TrainerMonNoItemCustomMoves sParty_Cristian[] = {
    ...
    .lvl = 1,
    .species = SPECIES_NICKIT,
    .moves = {MOVE_BEAT_UP, MOVE_SNARL, MOVE_SWIFT, MOVE_FAKE_TEARS}
    },
    {
    .iv = 200,
    .lvl = 1,
    ...
    .lvl = 1,
    .species = SPECIES_SANDILE,
    .moves = {MOVE_DIG, MOVE_BITE, MOVE_ROCK_SLIDE, MOVE_THUNDER_FANG}
    }
};

static const struct TrainerMonNoItemCustomMoves sParty_Takao[] = {
    {
    .iv = 127,
    .lvl = 1,
    .species = SPECIES_ABSOL,
...
static const struct TrainerMonNoItemCustomMoves sParty_Walter3[] = {
    ...
    .lvl = 1,
    .species = SPECIES_RAICHU,
    .moves = {MOVE_THUNDERBOLT, MOVE_IRON_TAIL, MOVE_SURF, MOVE_BRICK_BREAK}
    },
    {
    .iv = 220,
    .lvl = 1,
...
static const struct TrainerMonNoItemCustomMoves sParty_Walter4[] = {
    ...
    .moves = {MOVE_LUNGE, MOVE_FIRE_LASH, MOVE_CRUNCH, MOVE_POWER_WHIP}
    },
    {
    .iv = 220,
    .lvl = 1,
...
static const struct TrainerMonNoItemCustomMoves sParty_Valerie1[] = {
    {
    .iv =120,
    .lvl = 1,
    .species = SPECIES_TREVENANT,
    .moves = {MOVE_PHANTOM_FORCE, MOVE_WOOD_HAMMER, MOVE_HORN_LEECH, MOVE_DRAIN_PUNCH}
    },
    {
    .iv =120,
    .lvl = 1,
    .species = SPECIES_YAMASK,
    .moves = {MOVE_DARK_PULSE, MOVE_SHADOW_BALL, MOVE_WILL_O_WISP, MOVE_PROTECT}
    }
};

static const struct TrainerMonNoItemCustomMoves sParty_Valerie2[] = {
    {
    .iv =120,
    .lvl = 1,
    .species = SPECIES_TREVENANT,
    ...
    .lvl = 1,
    .species = SPECIES_RUNERIGUS,
    .moves = {MOVE_EARTHQUAKE, MOVE_SHADOW_BALL, MOVE_SANDSTORM, MOVE_DRAGON_PULSE}
    }
};

static const struct TrainerMonNoItemCustomMoves sParty_Valerie3[] = {
    {
    .iv =120,
    .lvl = 1,
    .species = SPECIES_TREVENANT,
    ...
    .lvl = 1,
    .species = SPECIES_CHANDELURE,
    .moves = {MOVE_SHADOW_BALL, MOVE_OVERHEAT, MOVE_SKITTER_SMACK, MOVE_CALM_MIND}
    }
};

static const struct TrainerMonNoItemCustomMoves sParty_Valerie4[] = {
    {
    .iv =120,
    .lvl = 1,
    .species = SPECIES_TREVENANT,
    ...
    .lvl = 1,
    .species = SPECIES_DECIDUEYE,
    .moves = {MOVE_SPIRIT_SHACKLE, MOVE_LEAF_STORM, MOVE_STEEL_WING, MOVE_LOW_SWEEP}
    }
};

static const struct TrainerMonNoItemCustomMoves sParty_Valerie5[] = {
    {
    .iv =120,
    .lvl = 1,
    .species = SPECIES_TREVENANT,
...
static const struct TrainerMonNoItemCustomMoves sParty_GruntAquaHideout3[] = {
    {
    .iv =130,
    .lvl = 1,
...
static const struct TrainerMonNoItemCustomMoves sParty_GruntAquaHideout4[] = {
    {
    .iv =130,
    .lvl = 1,
...
static const struct TrainerMonNoItemCustomMoves sParty_GruntAquaHideout5[] = {
    {
    .iv =130,
    .lvl = 1,
    .species = SPECIES_WALREIN,
...
static const struct TrainerMonNoItemCustomMoves sParty_GruntAquaHideout6[] = {
    {
    .iv =130,
    .lvl = 1,
    .species = SPECIES_TOXICROAK,
...
static const struct TrainerMonNoItemCustomMoves sParty_GruntAquaHideout7[] = {
    {
    .iv =130,
    .lvl = 1,
...
static const struct TrainerMonNoItemCustomMoves sParty_GruntAquaHideout8[] = {
    {
    .iv =130,
    .lvl = 1,
...
static const struct TrainerMonNoItemCustomMoves sParty_Isabella[] = {
    ...
    .ability = 0, // Water Absorb
    .species = SPECIES_DRACOVISH,
    .moves = {MOVE_FISHIOUS_REND, MOVE_DRAGON_RUSH, MOVE_LEECH_LIFE, MOVE_ZEN_HEADBUTT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Roland[] = {
    ...
    .ability = 1, // Skill Link
    .species = SPECIES_CLOYSTER,
    .moves = {MOVE_ICICLE_SPEAR, MOVE_ROCK_BLAST, MOVE_HYDRO_PUMP, MOVE_TOXIC_SPIKES}
    },
    {
    .iv =100,
    .lvl = 33,
...
static const struct TrainerMonItemCustomMoves sParty_Andrea[] = {
    ...
    .heldItem = ITEM_NEVER_MELT_ICE,
    .moves = {MOVE_LIQUIDATION, MOVE_ICICLE_CRASH, MOVE_HEAD_SMASH, MOVE_DOUBLE_EDGE}
    },
    {
    .iv = 100,
    .lvl = 39,
    ...
    .heldItem = ITEM_NEVER_MELT_ICE,
    .moves = {MOVE_LIQUIDATION, MOVE_ICICLE_CRASH, MOVE_AQUA_RING, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Bethany[] = {
    ...
    .heldItem = ITEM_MYSTIC_WATER,
    .moves = {MOVE_BOLT_BEAK, MOVE_ICICLE_CRASH, MOVE_METEOR_BEAM, MOVE_GIGA_IMPACT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Lao5[] = {
    ...
    .moves = {MOVE_SLUDGE_BOMB, MOVE_TOXIC, MOVE_SLUDGE_WAVE, MOVE_HEAT_WAVE}
    },
    {
    .iv =200,
    .lvl = 1,
...
static const struct TrainerMonItemCustomMoves sParty_Sandy2[] = {
    {
    .iv = 100,
    .lvl = 1,
    .ability = 0, // Sand stream
...
static const struct TrainerMonItemCustomMoves sParty_Sandy3[] = {
    {
    .iv = 100,
    .lvl = 1,
    .ability = 0, // Sand stream
...
static const struct TrainerMonItemCustomMoves sParty_Brawly2[] = {
    ...
    .species = SPECIES_TYRANITAR,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_STONE_EDGE, MOVE_STEALTH_ROCK, MOVE_PROTECT, MOVE_TOXIC}
    },
    {
    .iv = 100,
    .lvl = 1,
    ...
    .species = SPECIES_MANDIBUZZ,
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_ROOST, MOVE_FOUL_PLAY, MOVE_DEFOG, MOVE_U_TURN}
    },
    {
    .iv = 100,
    .lvl = 1,
    ...
    .moves = {MOVE_ROOST, MOVE_TAUNT, MOVE_DARK_PULSE, MOVE_DRACO_METEOR}
    },
    {
    .iv = 200,
    .lvl = 1,
    ...
    .species = SPECIES_GRENINJA,
    .heldItem = ITEM_CHOICE_SCARF,
    .moves = {MOVE_U_TURN, MOVE_ICE_BEAM, MOVE_GUNK_SHOT, MOVE_SPIKES}
    },
    {
    .iv = 255,
    .lvl = 1,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly5[] = {
    ...
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_HEAT_WAVE, MOVE_HURRICANE, MOVE_HYPER_BEAM, MOVE_SCORCHING_SANDS}
    },
    {
    .iv = 100,
    .lvl = 1,
    ...
    .moves = {MOVE_POWER_WHIP, MOVE_THRASH, MOVE_BRUTAL_SWING, MOVE_JUNGLE_HEALING}
    },
    {
    .iv = 255,
    .lvl = 1,
...
static const struct TrainerMonItemCustomMoves sParty_Angelo[] = {
    ...
    .species = SPECIES_JOLTIK,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDERBOLT, MOVE_X_SCISSOR, MOVE_GIGA_DRAIN, MOVE_POISON_JAB}
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_VIKAVOLT,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDERBOLT, MOVE_CHARGE_BEAM, MOVE_SUBSTITUTE, MOVE_DIG}
    }
};
