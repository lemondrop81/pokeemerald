const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_DELTA_BULBASAUR]	 = {{EVO_LEVEL, 16, SPECIES_DELTA_IVYSAUR}},
    [SPECIES_DELTA_IVYSAUR]	     = {{EVO_LEVEL, 32, SPECIES_DELTA_VENUSAUR}},
    [SPECIES_DELTA_CHARMANDER]	 = {{EVO_LEVEL, 16, SPECIES_DELTA_CHARMELEON}},
    [SPECIES_DELTA_CHARMELEON]	 = {{EVO_LEVEL, 36, SPECIES_DELTA_CHARIZARD}},
    [SPECIES_DELTA_SQUIRTLE]	 = {{EVO_LEVEL, 16, SPECIES_DELTA_WARTORTLE}},
    [SPECIES_DELTA_WARTORTLE]	 = {{EVO_LEVEL, 36, SPECIES_DELTA_BLASTOISE}},
    [SPECIES_DELTA_PAWNIARD]	 = {{EVO_LEVEL, 52, SPECIES_DELTA_BISHARP}},
};
