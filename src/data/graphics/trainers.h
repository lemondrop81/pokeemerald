...
const u32 gTrainerFrontPic_LeaderSandy[] = INCBIN_U32("graphics/trainers/front_pics/leader_Sandy_front_pic.4bpp.lz");
const u32 gTrainerPalette_LeaderSandy[] = INCBIN_U32("graphics/trainers/palettes/leader_Sandy.gbapal.lz");
