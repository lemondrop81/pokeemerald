...
const u32 gItemIcon_MegaRing[] = INCBIN_U32("graphics/items/icons/mega_bracelet.4bpp.lz");
const u32 gItemIconPalette_MegaRing[] = INCBIN_U32("graphics/items/icon_palettes/mega_bracelet.gbapal.lz");
