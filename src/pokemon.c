...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(DELTA_BULBASAUR),
    SPECIES_TO_NATIONAL(DELTA_IVYSAUR),
    SPECIES_TO_NATIONAL(DELTA_VENUSAUR),
    SPECIES_TO_NATIONAL(DELTA_CHARMANDER),
    SPECIES_TO_NATIONAL(DELTA_CHARMELEON),
    SPECIES_TO_NATIONAL(DELTA_CHARIZARD),
    SPECIES_TO_NATIONAL(DELTA_SQUIRTLE),
    SPECIES_TO_NATIONAL(DELTA_WARTORTLE),
    SPECIES_TO_NATIONAL(DELTA_BLASTOISE),
    SPECIES_TO_NATIONAL(DELTA_PAWNIARD),
    SPECIES_TO_NATIONAL(DELTA_BISHARP),
...
#endif
{
    ...
    [SPECIES_DELTA_BULBASAUR - 1]           = ANIM_GROW_VIBRATE,
    [SPECIES_DELTA_IVYSAUR - 1]             = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DELTA_VENUSAUR - 1]            = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DELTA_CHARMANDER - 1]          = ANIM_GROW_VIBRATE,
    [SPECIES_DELTA_CHARMELEON - 1]          = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DELTA_CHARIZARD - 1]           = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DELTA_SQUIRTLE - 1]            = ANIM_GROW_VIBRATE,
    [SPECIES_DELTA_WARTORTLE - 1]           = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DELTA_BLASTOISE - 1]           = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DELTA_PAWNIARD - 1]           = ANIM_CIRCULAR_VIBRATE,
    [SPECIES_DELTA_BISHARP - 1]           = ANIM_FIGURE_8,
